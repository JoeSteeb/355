...
p2c_test4 = TestCase (assertEqual "clusterCommon-test2" 
                                   (sort $ sortSnds [(2,[20]),(1,[10,1]),(4,[400,40]),(3,[3,30,300])])  
                                   (sort $ sortSnds $ clusterCommon [(1,10),(4,400),(3,3),(2,20),(3,30),(1,1),(4,40),(3,300)]) ) 
p2c_test5 = TestCase (assertEqual "clusterCommon-test3" 
                                   ([]::[(Int,[Int])]) 
                                   (clusterCommon []) ) 
...
p3_test3 = TestCase (assertEqual "(maxNumCases-test3)" 
                                  ...
                                  "Jan") ) 
p3_test4 = TestCase (assertEqual "(maxNumCases-test2)" 
                                  4000 (maxNumCases cdcData 
                                  "Apr") ) 
p3_test5 = TestCase (assertEqual "(maxNumCases-test3)" 
                                  0  (maxNumCases cdcData 
                                  "Jan") ) 
...
p4_test3 = TestCase (assertEqual "(groupIntoLists-test3)" 
                                  []  (groupIntoLists "") ) 
p4_test4 = TestCase (assertEqual "(groupIntoLists-test2)" 
                                  ["a","bc","def","ghij","klmno","pqrstu","wxyz012"]  (groupIntoLists "abcdefghijklmnopqrstuwxyz012") ) 
p4_test5 = TestCase (assertEqual "(groupIntoLists-test3)" 
                                  []  (groupIntoLists "") ) 
