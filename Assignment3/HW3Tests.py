...
class HW3SampleTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.graph = {'A': {'B', 'C', 'D'}, 'B': {'C'}, 'C': {'B', 'E', 'F', 'G'}, 'D': {
    ...
    def test_1_merge_year(self):
        output1 = {'Oceanfish': 13, 'Tuna': 6, 'Whitefish': 7,
                   'Chicken': 15, 'Beef': 4, 'Salmon': 5, 'Turkey': 1, 'Sardines': 1}
        self.assertDictEqual(merge_year(self.my_cats_log, 2019), output1)
        output2 = {'Salmon': 6, 'Whitefish': 6, 'Turkey': 8, 'Beef': 16, 'Tuna': 10,
                   'MixedGrill': 2, 'Scallop': 9, 'Chicken': 15, 'Oceanfish': 5, 'Sardines': 4}
    ...
    def test_1_getmax_of_flavor(self):
        output1 = ((5, 2021), 5)
        self.assertTupleEqual(getmax_of_flavor(
            self.my_cats_log, "Tuna"), output1)
        output2 = ((9, 2021), 6)
        self.assertTupleEqual(getmax_of_flavor(
            self.my_cats_log, "Beef"), output2)
